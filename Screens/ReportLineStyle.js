    ...
    fetch(
      ...
      .then((responseJson) => {
        ...
        this.setState({
          ...
          Ok:responseJson.result[0].lineDetails[0].okPieces,
          Reject:responseJson.result[0].lineDetails[0].rejectedPieces,
          Defect:responseJson.result[0].lineDetails[0].defectedPieces,
          Alter:responseJson.result[0].lineDetails[0].alteredPieces,
          FrontURL:frontURL,
          BackURL:backURL,
          DefectList:temp
        });
