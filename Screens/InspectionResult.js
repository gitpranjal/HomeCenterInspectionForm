        ...
        <View style={{alignItems: "flex-start", marginHorizontal: 10}}>
          ...
          {(() => {
            ...
            if(outcomeObject != "undecided" && !OutcomeRadioButtonPressed)
              ...
              return (
                <RadioButtonRN
                  style={{width: "50%", marginHorizontal: 25, marginVertical: 20}}
                  initial={(() => {
          ...
          <FloatingLabelInput
              ...
              <FloatingLabelInput
                 ...
                 label="Comments"
                 labelStyles={{color: "grey", fontSize: 15, fontWeight: "bold", top: -3}}
             
                 inputStyles={{color: "grey", fontWeight: "bold"}}
                 containerStyles={{...styles.input, width: Dimensions.get("window").width / 1.07, height: 120, alignItems: "flex-start"}}
                 inputStyles={{fontWeight: "bold", fontSize: 16, color: Colors.primaryColor, top: "2%", textAlign: "left"}}
                 maxLength={70}
                 showCountdown={true}
                 multiline={true}
                 editable={InspectionEnteries.inspectionID == 0}
